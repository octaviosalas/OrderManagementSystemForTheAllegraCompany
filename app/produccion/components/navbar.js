      ...
      <div className="w-full flex items-center justify-between  red-600 h-12 mt-2">
        <div className="flex ml-6 items-center">
          <div className="dropdown ">
            ...
            <ul
              tabIndex={1}
              className="bg-gray-200 menu menu-sm dropdown-content mt-3 z-[1] p-2  rounded-box w-52"
            >
              <li>
                <a onClick={handleChangeTheme}>Dark Mode</a>
              </li>
              <li>
                <a>.............</a>
              </li>
          ...
          <div>
            <img
              ...
              className="h-11 w-11 ml-6 dark:text-white object-contain"
            />
          </div>
          <div className="hidden lg:block">
            <div className="flex ml-4 items-center gap-6 lg:gap-9 xl:gap-16 ">
              <p className="text-black cursor-pointer hover:underline dark:text-white">
                Tienda Mayorista
              </p>
              ...
              <Link href="/produccion/users">
                {" "}
                <p className="text-black cursor-pointer hover:underline dark:text-white">
                  Usuarios
                </p>{" "}
              </Link>
              <Link href="/produccion/cargarPedido">
                {" "}
                <p className="text-black cursor-pointer hover:underline dark:text-white">
                  Cargar Pedidos
                </p>{" "}
